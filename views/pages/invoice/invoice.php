...
<head>
  ...
  <div class="row invoice-preview">
    ...
    <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
      <div class="card">
        <div class="card-body">
          <button class="btn btn-dark w-100 mb-75" data-bs-toggle="modal" data-bs-target="#send-invoice-sidebar">
            Send Invoice
          </button>
...
<!-- Mirrored from pixinvent.com/demo/Factura-html-bootstrap-admin-template/html/ltr/horizontal-menu-template-dark/app-invoice-preview.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Jun 2022 05:57:52 GMT -->
</html>