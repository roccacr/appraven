  ...
  if ($response->status == 200) {
    ...
    foreach ($response as $data) {
      if ($data->estado == "Aceptada") {
        ...
        $nombre_fichero = 'views/xmlFacturaNc/NC-' . $clave_array . '.xml';
        if (file_exists($nombre_fichero)) {
        } else {
          $xml = new DOMDocument('1.0');
          $encode = base64_decode($data->xml_firmado);
          $xml = simplexml_load_string($encode, "SimpleXMLElement", LIBXML_NOCDATA);
          $xml->saveXML('views/xmlFacturaNc/NC-' . $clave_array . '.xml'); // Wrote: 72 bytes
        }
        $select = "*";
              ...
              <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="views/xmlFacturaNc/NC-<?php echo $clave_array; ?>.xml" class="btn btn-outline-secondary w-100 btn-download-invoice mb-75" download="NC-<?php echo $clave_array; ?>.xml">
