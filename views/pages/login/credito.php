...
/* Comprobando si la variable  está configurada. */
  if (isset($routesArray)) {
    $select = "*";
    $url = "$tbl_creditonotas?select=*&linkTo=$clave_credito&equalTo=" . $routesArray;
    $method = "GET";
    $fields = array();
                    ...
                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                      <div>
                        ...
                        <img width="150px" src="../../../../app-assets/images/logos/image.png">
                          <h3 class="text-dark invoice-logo">Nota de Credito</h3>
                        </div>
              ...
              <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a class="btn btn-outline-secondary w-100 mb-75" href="/pdf/<?php echo base64_encode("$tbl_creditonotas");?>/<?php echo base64_encode($clave_credito);?>/<?php echo base64_encode($routesArray);?>"><i data-feather='file-text'></i> Generar PDF </a>
                 <?php } else {
                  echo '<div class="alert alert-danger" role="alert">
               <h4 class="alert-heading">Lo sentimos</h4>
               <div class="alert-body">
               No se pede mostrar el resultado por que la factura: ' . $routesArray . ' no esta Aceptada.<br>
               Estado de la Factura : ' . $data->$estado_creditonotas_var . '
               </div>
             </div>'; ?>
                <?php }
              }
