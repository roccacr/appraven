        ...
        <div class="container invoice">
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <div class="parent">
                            ...
                            <div class="divtres"> <img style="float: left;" class="media-object logo"
                                    src="../../../app-assets/images/logos/eite.png" /></div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-4">
                        <div class="media">
                            ...
                            <ul class="media-body list-unstyled">
                                ...
                                <li
                                    style="text-align: center;  border-width: 1px; border-style: solid; border-color: rgb(10, 10, 10); border-radius: 8px">
                                    <br> <strong><?php echo $typepdf; ?> No.<?php echo $idAdmCloud; ?></strong><br><br>
                                </li>
                                <br>
                                <li
            ...
            <div class="invoice-body">
                <div class="encabezado">
                    ...
                    <div class="cliente-comercial"
                        style="border-image: initial; border: 1px solid black; border-radius: 5px">
            ...
            <div class="invoice-body">
                <div class="panel panel-lineas">
                    <table class="table table-bordered table-condensed tabla-articulos"
                        style="  text-align: center;  border-image: initial; border: 1px solid black; border-radius: 5px">
                        <thead
                            style="  text-align: center;  border-image: initial; border: 1px solid black; border-radius: 5px">
                            <tr>
                    ...
                    ?>
                            <tr>
                                <th class="text-left"
                                    style="  text-align: center;  border-image: initial; border: 1px solid black; border-radius: 5px">
                                    <?php echo  number_format($Cantidad, 3, ".", ","); ?></th>
                                <th class="text-left"
                                    style="  text-align: center;  border-image: initial; border: 1px solid black; border-radius: 5px">
                                    <?php echo  $codigoRest; ?></th>
                                <th class=""
                                    style="border-image: initial; border: 1px solid black; border-radius: 5px;">
                                    <label style="font-weight: 400;"><?php echo  $Detelle; ?></label>
                                </th>
                                <th hidden class="text-left"
                                    style="  text-align: center;  border-image: initial; border: 2px solid black; border-radius: 5px">
                                    $3,312.00</th>
                                <th class="text-left"
                                    style="  text-align: center;  border-image: initial; border: 1px solid black; border-radius: 5px">
                                    <?php echo  $tarifa; ?></th>
            ...
            <div class="invoice-body">
                ...
                <div class="parent4">
                    <div class="divinfofeTC" style="  text-align: center;"> ***<?php echo $typepdf; ?> EN :
                        <?php echo $facturaEn ?>
                        <?php echo $tipoC ?> *** </div>
                    <div class="divresolucion" style="  text-align: center;"> <label
                            style="font-weight: 400; font-size: 11px"> Autorizado mediante resolución DGT-R-033-2019 del
                            veinte de junio de dos mil diecinueve.</label> </div>
                </div>
                <hr>
            </div>
        </div>
