...
<div class="app-content content ">
    ...
    if (isset($routesArray[3]) == false) {
      ...
      if (isset($routesArray)) {
        $select = "*";
        $url = "$tbl_creditonotas?select=*&linkTo=$routesArray2&equalTo=" . $routesArray;
        $method = "GET";
        $fields = array();
    ...
    ?>
        ...
        <html class="loading dark-layout" lang="en" data-layout="dark-layout" data-textdirection="ltr">
            ...
            <head>
                ...
                <link rel="shortcut icon" type="image/x-icon"
                    href="https://pixinvent.com/demo/Factura-html-bootstrap-admin-template/app-assets/images/ico/favicon.ico">
                <link
      ...
      if ($response->status == 200) {
        ...
        foreach ($response as $data) {
          ...
          Estado de la factura: ' . $data->$estado_creditonotas . '
          </div>
        </div>';

            $llave = $data->$clave_credito;
      ...
      ?>
                                        ...
                                        <div
                                            ...
                                            <div>
                                                <div class="logo-wrapper">
                                                    <img width="150px"
                                                        src="../../../../app-assets/images/logos/image.png">
                                                    <h3 class="text-dark invoice-logo">Factura NC</h3>
                                                </div>
                                                <script src="https://unpkg.com/qrious@4.0.2/dist/qrious.js"></script>
                                                <p class="card-text mb-25">Consecutivo:
                                                    <?php echo $NumeroConsecutivo; ?> </p>
                                                <p class="card-text mb-25">Emisor: <?php echo $Nombre; ?> </p>
                                                <p class="card-text mb-25">Cedula Juridica: <?php echo $NumeroCedula; ?>
                                                </p>
                                                <p class="card-text mb-25">Direccion: <?php echo  $OtrasSenas; ?> </p>
                                                <p class="card-text mb-25">Fecha de emisión:
                                                    <?php echo  $FechaEmision;; ?> </p>
                                            </div>
                                            <div class="mt-md-0 mt-2">
                                                ...
                                                <img style="float:right;" width="100%" class="mb-60" alt="Código QR"
                                                    id="codigo">
                                                <script>
                            ...
                            ?>
                                                <tr>
                                                    <td class="py-1">
                                                        <p class="card-text fw-bold mb-25">
                                                            <?php echo  $LineaDetalle[$NumeroLinea_xml_factura]; ?></p>
                                                    </td>
                                                    <td class="py-1">
                                                    ...
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold"><?php echo  $LineaDetalle[$Cantidad_xml_factura]; ?></span>
                                                    </td>
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold"><?php echo  $LineaDetalle[$Detalle_xml_factura]; ?></span>
                                                    </td>
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold"><?php echo  $LineaDetalle[$PrecioUnitario_xml_factura]; ?></span>
                                                    </td>
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold"><?php echo  $LineaDetalle[$MontoTotal_xml_factura]; ?></span>
                                                    </td>
                                                    <td class="py-1">
                                                    ...
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold"><?php echo  $LineaDetalle[$MontoTotalLinea_xml_factura]; ?></span>
                                                    </td>
                                                </tr>
                                                <?php break;
                              } else {
                              ...
                              ?>
                                                <tr>
                                                    <td class="py-1">
                                                        <p class="card-text fw-bold mb-25">
                                                            <?php echo  $data[$NumeroLinea_xml_factura]; ?></p>
                                                    </td>
                                                    <td class="py-1">
                                                        <span class="fw-bold"><?php echo  $codigoRest; ?></span>
                                                    </td>
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold"><?php echo  $data[$Cantidad_xml_factura]; ?></span>
                                                    </td>
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold"><?php echo  $data[$Detalle_xml_factura]; ?></span>
                                                    </td>
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold"><?php echo  $data[$PrecioUnitario_xml_factura]; ?></span>
                                                    </td>
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold"><?php echo  $data[$MontoTotal_xml_factura]; ?></span>
                                                    </td>
                                                    <td class="py-1">
                                                        <span class="fw-bold"><?php echo  $Monto ?></span>
                                                    </td>
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold"><?php echo  $data[$MontoTotalLinea_xml_factura]; ?></span>
                                                    </td>
                                                </tr>
                                                <?php }
                            } ?>
                                        ...
                                        <div class="row invoice-sales-total-wrapper">
                                            <div class="col-md-6 order-md-1 order-2 mt-md-0 mt-3">
                                                <p class="card-text mb-0">
                                                    <span class="fw-bold">Resumen Factura:</span> <span
                                                        class="ms-75"></span>
                                                </p>
                                            </div>
                                            <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                                <div class="invoice-total-wrapper">
                                                    <div class="invoice-total-item">
                                                        <p class="invoice-total-title">Total Mercancias Gravadas:
                                                            <?php echo  $TotalMercanciasGravadas; ?></p>
                                                    </div>
                                                    <hr class="my-50" />
                                                    <div class="invoice-total-item">
                                                        <p class="invoice-total-title">Total Gravado:
                                                            <?php echo  $TotalGravado; ?></p>
                                                    </div>
                                                    <hr class="my-50" />
                                                    <div class="invoice-total-item">
                                                        <p class="invoice-total-title">Total Venta:
                                                            <?php echo  $TotalVenta; ?></p>
                                                    </div>
                                                    <hr class="my-50" />
                                                    <div class="invoice-total-item">
                                                        <p class="invoice-total-title">Total Venta Neta:
                                                            <?php echo  $TotalVentaNeta; ?></p>
                                                    </div>
                                                    <div class="invoice-total-item">
                                                        <p class="invoice-total-title">Total Impuesto:
                                                            <?php echo  $TotalImpuesto; ?></p>
                                                    </div>
                                                    <hr class="my-50" />
                                                    <div class="invoice-total-item">
                                                        <p class="invoice-total-title">TotalComprobante:
                                                            <?php echo  $TotalComprobante; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body invoice-padding pt-0">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <span>Nota: Fue un placer trabajar con usted y su equipo. Esperamos que
                                                    nos tengas en cuenta para futuros proyectos freelance.
                                                    ¡Gracias!</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="<?php echo $ruta_xmlMenHacienda; ?><?php echo $claveHaciendaDescargar; ?>.xml"
                                            class="btn btn-outline-secondary w-100 btn-download-invoice mb-75"
                                            download="<?php echo $sufix_hac_men; ?><?php echo $claveHaciendaDescargar; ?>.xml">
                                            <i class="fa fa-cloud-download" aria-hidden="true"></i></i> Mensaje Hacienda
                                        </a>
                                        <?php } ?>
                                        <a class="btn btn-outline-secondary w-100 mb-75" href="/factura/consultar"><i
                                                data-feather='search'></i> Consultar otra factura </a>
                                        <a class="btn btn-outline-secondary w-100 mb-75"
                                            href="/factura/pdf/<?php echo base64_encode("$tbl_creditonotas"); ?>/<?php echo base64_encode($clave_credito); ?>/<?php echo base64_encode($llave); ?>"><i
                                                data-feather='file-text'></i> Generar PDF </a>
                                        <?php } else {
               ...
               Estado de la Factura : ' . $data->estado . '
                                        ...
                                        <a class="btn btn-outline-secondary w-100 mb-75" href="/factura/consultar">
                                            Consultar otra Factura </a>
                                        <?php }
                  }
                } else { ?>
                                        <a class="btn btn-outline-secondary w-100 mb-75" href="/factura/consultar">
