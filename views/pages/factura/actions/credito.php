                  ...
                  <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <a class="btn btn-outline-secondary w-100 mb-75" href="/factura/pdf/<?php echo base64_encode("$tbl_creditonotas"); ?>/<?php echo base64_encode($clave_credito); ?>/<?php echo base64_encode($llave); ?>"><i data-feather='file-text'></i> Generar PDF </a>
                      <?php } else {
