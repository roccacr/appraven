...
if($responsepermisos->status == 200){
 ...
 if ($data->$consultarAproviNc_va==1){
?>
                                ...
                                <?php
                                  ...
                                  if ($response->status == 200) {
                                    ...
                                    foreach($response as $data){?>
                                        <tr>
                                            <td> <?php echo $data->$clave_aprnc_va;?></td>
                                            
                                            <td> <?php echo $data->$id_admcloud_aprnc_va;?></td>
                                            <td> <?php echo $data->$consecutivo_aprnc_va;?>   </td>
                                            <td> <?php echo $data->$status_aprnc_va ;?> </td>
                                         
                                            <td> <?php echo $data->$id_internoadm_aprnc_va;?></td>
                                            <td>
                                                 <center>
