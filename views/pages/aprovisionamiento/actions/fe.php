...
if($responsepermisos->status == 200){
 ...
 if ($data->$consultarAproviFe_va==1){
?>
                                ...
                                <?php
                                  ...
                                  if ($response->status == 200) {
                                    ...
                                    foreach($response as $data){?>
                                        <tr>
                                            <td> <?php echo $data->$clave_aprfac_va;?></td>
                                            
                                            <td> <?php echo $data->$id_admcloud_aprfac_va;?></td>
                                            <td> <?php echo $data->$consecutivo_aprfac_va;?>   </td>
                                            <td> <?php echo $data->$status_aprfac_va;?> </td>
                                         
                                            <td> <?php echo $data->$id_internoadm_aprfac_va;?></td>
                                            <td>
                                                 <center>
